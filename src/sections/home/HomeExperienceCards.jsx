...
const CARDS = [
  {
    ...
    title: '.Net',
    description:
      'Managed and developed code first DB with EF Core O/RM in clean architecture projects, implement SignalR and Quartz, and much more ...',
    color: 'purple',
  },
  {
    ...
    title: 'React JS',
    description:
      'Developed React-js dynamic web CMMS application, create dynamic components for whole app ,create custom hooks and dominate on hooks,experience with redux and much more ...',
    color: 'white',
  },
  {
    icon: 'skill-icons:docker',
    title: 'Docker',
    description: 'have experience with Docker ,Portainer and cosul for Published Projects  ',
    color: 'black',
  },
];
              ...
              {(progress) => (
                <Timeline totalProgress={progress}>
                  <Tween from={{ x: '1000px' }} to={{ x: '0px' }} duration={1000}>
                    ...
                    <Typography variant="h2"> Some of my Experiences </Typography>
                  </Tween>
                </Timeline>
              )}
            </Scene>
