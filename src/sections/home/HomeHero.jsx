          ...
          <ContentStyle>
            <m.div variants={varFade().inDown}>
              <Typography variant="h1" sx={{ color: 'common.white' }}>
                ...
                <m.div variants={varFade().inDown} onClick={animate}>
            ...
            <m.div variants={varFade().inDown}>
              <Typography sx={{ color: 'common.white' }}>Full stack web developer with 2/5 years experience</Typography>
            </m.div>
            ...
            <Stack spacing={2.5} alignItems="center" direction={{ xs: 'column', md: 'row' }}>
              <m.div variants={varFade().inRight}>
                <TextIconLabel
                  value={
                    <Link
                      href="https://github.com/SinaGolkar"
                      target="_blank"
                      rel="noopener"
                      color="common.white"
                      sx={{ typography: 'body2' }}
              ...
              <m.div variants={varFade().inRight}>
                <TextIconLabel
                  ...
                  value={
                    <Link
                      // href="https://www.linkedin.com/in/sina-golkar-8a79b5210"
                      target="_blank"
                      rel="noopener"
                      color="common.white"
                      sx={{ typography: 'body2' }}
